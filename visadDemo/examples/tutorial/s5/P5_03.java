...
/**
  VisAD Tutorial example 5_03
  The same sine curve, but now with Time -> ZAxis
  Run program with java P5_03
 *
 */
...
public class P5_03{
  ...
  public P5_03 (String[] args)
    ...
    // can also create a new type like this
    ...
    int tSamples = 12;
    timeSet = new Integer1DSet(time,  tSamples);
    ...
    JFrame jframe = new JFrame("VisAD Tutorial example 5_03");
...
} //end of Visad Tutorial Program 5_03
