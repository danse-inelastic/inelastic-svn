...
/**
  VisAD Tutorial example 5_07
  Like example 5_06, but with a VisADSlider and a SelectValue map
  An animated surface with MathType
   ( time -> (( longitude, latitude )  -> ( altitude, temperature ) ) )
  Run program with java P5_07
 *
 */
...
public class P5_07{
  ...
  public P5_07 (String[] args)
    ...
    vSlider = new VisADSlider(selValMap, 10, 22);
    ...
    JFrame jframe = new JFrame("VisAD Tutorial example 5_07");
...
} //end of Visad Tutorial Program 5_07
