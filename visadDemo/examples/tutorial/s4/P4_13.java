...
// Declare variables
  ...
  public P4_13(String []args)
    ...
    JFrame jframe = new JFrame("VisAD Tutorial example 4_13");
    jframe.getContentPane().setLayout(new FlowLayout());
    jframe.getContentPane().add(display.getComponent());

    // Add the ContourWidget to the frame

    jframe.getContentPane().add(contWid);
