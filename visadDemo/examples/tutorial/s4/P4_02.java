...
import visad.util.*;
  ...
  Like example 4_02 but using a ContourWidget
...
// Declare variables
  ...
  private ScalarMap tempIsoMap, altIsoMap;

  // The ContourWidget

  private ContourWidget contourWid;

  public P4_02(String []args)
    ...
    // The ContourWidget
    // Note that we create the widget from the IsoContour map
    ...
    // Add the ContourWidget to the frame

    jframe.getContentPane().add(contourWid);
