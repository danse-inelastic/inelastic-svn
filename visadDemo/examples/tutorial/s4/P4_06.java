...
import java.awt.event.*;
  ...
  /**
  VisAD Tutorial example 4_06
  Illustrate use of transparency (Alpha value)
  Use a loop to create a color table
  We have the function altitude = h(latitude, longitude)

  represented by the MathType
  ( (latitude, longitude) -> altitude )
  altitude values in the code
  Run program with "java P4_06"
 */
...
} //end of Visad Tutorial Program 4_06
