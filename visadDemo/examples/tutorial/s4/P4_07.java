...
import java.awt.event.*;
  ...
  /**
  VisAD Tutorial example 4_07
  Illustrate use of transparency (Alpha value) with ContantMaps
  We have the function altitude = h(latitude, longitude)

  represented by the MathType
  ( (latitude, longitude) -> altitude )
  altitude values in the code
  Run program with "java P4_07"
 */
...
// Declare variables
  ...
  // order MATTERS!
   ...
   display.addReference( data_ref, constAlpha_CMap );
    ...
    JFrame jframe = new JFrame("VisAD Tutorial example 4_07");
...
} //end of Visad Tutorial Program 4_07
