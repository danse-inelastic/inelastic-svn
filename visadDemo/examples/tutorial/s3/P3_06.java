...
import java.awt.event.*;
  ...
  /**
  VisAD Tutorial example 3_06
  Like example 3_06, but with denser contours
  We have the function temperature = f(latitude, longitude)
  represented by the MathType
  ( (latitude, longitude) -> elevation )
  Use ContourControl
  Run program with "java P3_06"
 */
...
// Declare variables
  ...
  public P3_06(String []args)
    ...
    JFrame jframe = new JFrame("VisAD Tutorial example 3_06");
