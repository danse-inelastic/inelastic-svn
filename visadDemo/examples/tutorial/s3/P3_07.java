...
import java.awt.event.*;
  ...
  /**
  VisAD Tutorial example 3_07
  Like example 3_06, but with isocontour over image
  We have the function temperature = f(latitude, longitude)
  represented by the MathType
  ( (latitude, longitude) -> elevation )
  Run program with "java P3_07"
 */
...
} //end of Visad Tutorial Program 3_07
