...
Sample Builder.  The key points of interest are the methods: __init__() 
...
@author: Jeff Birac
@copyright: Copyright (c) 2007 Brandon Keith  All rights reserved.
@version: 0.1

$Id: AtomGeneratorPropertyManager.py,v 1.2 2007/08/07 22:05:53 polosims Exp $
