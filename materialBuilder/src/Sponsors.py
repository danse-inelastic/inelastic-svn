...
$Id: Sponsors.py,v 1.18 2007/08/09 17:06:21 polosims Exp $

We want to recoup some of the costs of developing Sample Builder in a
...
_sponsordir = platform.find_or_make_materialBuilder_subdir('Sponsors')
_sponsors = { }
...
class PermissionDialog(QDialog, threading.Thread):
    ...
    text = ("We would like to use your network connection to update a list of our " +
            ...
            "just use buttons with our own materialBuilder logo.")
...
_materialBuilderLogo = '''iVBORw0KGgoAAAANSUhEUgAAAH0AAAApCAIAAACX/bGTAAAABmJLR0QA/wD/AP+gvaeTAAAACXBI
...
_materialBuilderText = """\
materialBuilder created Sample Builder, the program you're using right now.
Please see http://www.nanoengineer-1.com for more information."""

_defsp_png = base64.decodestring(_materialBuilderLogo)
_defsp_imgfile = os.path.join(_sponsordir, 'logo_materialBuilder.png')
open(_defsp_imgfile, 'wb').write(_defsp_png)
_defaultSponsor = Sponsor('materialBuilder', fixHtml(_materialBuilderText), _defsp_imgfile)
