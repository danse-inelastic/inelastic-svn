...
class Ui_ServerManagerDialog(object):
    ...
    def retranslateUi(self, ServerManagerDialog):
        ...
        self.username_linedit.setText(QtGui.QApplication.translate("ServerManagerDialog", "materialBuilder", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.password_linedit.setText(QtGui.QApplication.translate("ServerManagerDialog", "materialBuilder", None, QtGui.QApplication.UnicodeUTF8))
