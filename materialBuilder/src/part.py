...
$Id: part.py,v 1.78 2007/07/26 16:40:36 ninad Exp $
...
class Part( jigmakers_Mixin, InvalMixin, StateMixin,
    ...
    _s_attr_homeCsys = S_CHILD
    _s_attr_lastCsys = S_CHILD
    ## not true, i think: _s_categorize_homeCsys = 'view' # [bruce 060227]
    _s_categorize_lastCsys = 'view' # [bruce 060227]
    _s_attr_ppa2 = S_REF
    _s_attr_ppa3 = S_REF
    _s_attr_ppm = S_REF
