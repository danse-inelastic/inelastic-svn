...
$Id: JobManager.py,v 1.15 2007/07/01 17:27:31 emessick Exp $
"""
__author__ = "Mark"
...
def touch_job_id_status_file(job_id, Status='Queued'):
    ...
    jobdir = find_or_make_materialBuilder_subdir('JobManager')
    
    # Job Id dir (i.e. ~/materialBuilder/JobManager/123/)
...
def get_job_manager_job_id_and_dir():
    ...
    while 1:
        ...
        # Create Job Id subdir (i.e. ~/materialBuilder/JobManager/123/)
        job_id_dir  = os.path.join(jobdir, str(job_id))
        
        # Make sure there isn't already a Job Id subdir in ~/materialBuilder/JobManager/
...
class JobManager(QWidget, Ui_JobManagerDialog):
    ...
    def refresh_job_table(self):
        ...
        scratch by reading the ~/materialBuilder/JobManager/ directory.
        """
