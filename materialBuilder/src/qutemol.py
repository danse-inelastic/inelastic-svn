...
$Id: qutemol.py,v 1.11 2007/07/01 17:27:32 emessick Exp $
...
def write_art_file(filename):
    ...
    f.write("#@ Sample Builder Atom Rendering Table, file format version 2007-06-04\n")
...
def write_qutemol_pdb_file(part, filename):
    ...
    f.write("REMARK   1 @ Sample Builder/QuteMol PDB File Format\n")
...
def write_qutemol_files(part):
    '''Writes a PDB of the current <part> and an ART file to the materialBuilder temp directory.
    ...
    # Make full pathnames for PDB and ART files (in ~/materialBuilder/temp/)
    from platform import find_or_make_materialBuilder_subdir
    tmpdir = find_or_make_materialBuilder_subdir('temp')
