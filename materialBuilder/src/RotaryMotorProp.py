...
$Id: RotaryMotorProp.py,v 1.33 2007/07/01 17:27:31 emessick Exp $
"""
...
class RotaryMotorProp(QDialog, Ui_RotaryMotorPropDialog):
    def __init__(self, motor, glpane):
        ...
        motor during a simulation. See the Rotary Motor web page on the Sample Builder Wiki for more information.</p>""")
