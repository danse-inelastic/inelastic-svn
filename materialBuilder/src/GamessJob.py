...
$Id: GamessJob.py,v 1.34 2007/07/01 17:27:31 emessick Exp $
"""
__author__ = "Mark"
...
class GamessJob(SimJob):
    ...
    def launch(self):
        ...
        # Write INP file (in ~/materialBuilder/JobManager/Job Id subdirectory)
        writegms_inpfile(self.job_inputfile, self.gamessJig)
        
        # Create BAT file (in ~/materialBuilder/JobManager/Job Id subdirectory)
