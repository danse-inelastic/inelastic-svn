...
$Id: GamessProp.py,v 1.45 2007/07/01 17:27:31 emessick Exp $
...
class GamessProp(QDialog, Ui_GamessPropDialog):
    ...
    def __init__(self):
        ...
        self.edit_input_file_cbox.setWhatsThis("""Opens the INP file generated by Sample Builder in a text editor.""")
...
#            self.soscf_checkbox.setEnabled(1)
    ...
    def open_tmp_inputfile(self):
        ...
        file in an editor.
        '''
        # Make tmp_inputfile filename (i.e. ~/materialBuilder/temp/jigname_parms_info.inp)
        ...
        # Write INP file (in ~/materialBuilder/temp subdirectory)
