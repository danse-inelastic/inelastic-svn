...
$Id: PovrayScene.py,v 1.27 2007/07/01 17:27:31 emessick Exp $
...
import platform
from platform import find_or_make_any_directory, find_or_make_materialBuilder_subdir
...
class PovrayScene(SimpleCopyMixin, Node):
    ...
    def get_povfile_trio(self, tmpfile = False):
        ...
        if tmpfile:
            ...
            dir = find_or_make_materialBuilder_subdir("POV-Ray")
            if not dir:
    ...
    def raytrace_scene(self, tmpscene = False):
        ...
        If tmpscene is True, the INI and pov files are written to a temporary directory (~/materialBuilder/POV-Ray).
