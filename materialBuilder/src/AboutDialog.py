...
class Ui_AboutDialog(object):
    ...
    def retranslateUi(self, AboutDialog):
        AboutDialog.setWindowTitle(QtGui.QApplication.translate("AboutDialog", "About Sample Builder", None, QtGui.QApplication.UnicodeUTF8))
        self.textLabel1.setText(QtGui.QApplication.translate("AboutDialog", "Sample Builder Version 1.0 (Alpha)", None, QtGui.QApplication.UnicodeUTF8))
        self.textLabel2.setText(QtGui.QApplication.translate("AboutDialog", "Copyright 2004-2007, Brandon Keith", None, QtGui.QApplication.UnicodeUTF8))
        self.textLabel2_2.setText(QtGui.QApplication.translate("AboutDialog", "www..com", None, QtGui.QApplication.UnicodeUTF8))
