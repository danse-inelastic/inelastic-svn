...
$Id: CoNTubGenerator.py,v 1.20 2007/07/01 17:27:31 emessick Exp $
...
class PluginlikeGenerator:
    ...
    <p>This is materialBuilder\'s modified version of the CoNTub source code written
    ...
    <p>materialBuilder\'s modifications include translation from Java to C++,
...
class HeterojunctionGenerator(PluginlikeGenerator):
    ...
    plugin_name = "CoNTub"
        # used as directory name, looked for in ~/materialBuilder/Plugins someday, and in cad/plugins now and someday...
