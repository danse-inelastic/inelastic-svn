...
$Id: NanoHiveUtils.py,v 1.23 2007/07/01 17:27:31 emessick Exp $
...
def get_nh_simspec_filename(basename):
    ...
    '''
    if basename:
        nhdir = find_or_make_materialBuilder_subdir("Nano-Hive")
...
def run_nh_simulation(assy, sim_id, sim_parms, sims_to_run, results_to_save):
    ...
    from platform import find_or_make_materialBuilder_subdir
    output_dir = find_or_make_materialBuilder_subdir("Nano-Hive") # ~/materialBuilder/Nano-Hive
