...
$Id: test.py,v 1.302 2007/07/04 22:36:17 bsmith Exp $
...
testexpr_11m = imagetest(courierfile) # works
    ...
    #  screenshot on g5 is in /materialBuilder/bug notes/clamped is blue.jpg
...
testexpr_11ocx = imagetest("RotateCursor.bmp", convert = True, _tmpmode = 'JPEG') # see if this fixes exception -- well, not quite:
    ...
    ## <nEImageOps at 0xf029d28 for '/materialBuilder/Working/cad/images/RotateCursor.bmp'>.update
...
testexpr_11pcy2 = imagetest("win_collapse_icon.png", convert = 'RGBA', _tmpmode = 'TIFF') # works, looks worse than pcx2, improper alpha
    ...
    ## /materialBuilder/bug notes/1059 files/IMG_1615.JPG: JPEG image data, EXIF standard 0.73, 10752 x 2048
...
_dir1 = "/materialBuilder/confirmation-corner/" # not in cvs
...
## _dir2 = "/materialBuilder/confirmation-corner/new-icons/" # not in cvs
...
testexpr_11q1 = imagetest("/materialBuilder/bug notes/1059 files/IMG_1615.JPG") # works
testexpr_11q1b = Image("/materialBuilder/bug notes/1059 files/IMG_1615.JPG", ideal_width = 1704, ideal_height = 2272) # works [070223]
testexpr_11q2 = imagetest("/materialBuilder/bug notes/bounding poly bug.jpg") # works
testexpr_11q3 = imagetest("/materialBuilder/bug notes/1059 files/peter-easter-512.png") # works
testexpr_11q4 = imagetest("/materialBuilder/bug notes/1059 files/IMG_1631.JPG alias") # (mac alias) fails
    ## IOError: cannot identify image file [images.py:56] [testdraw.py:658] [ImageUtils.py:28] [Image.py:1571]
testexpr_11q5 = imagetest("/materialBuilder/DNA/paul notebook pages/stages1-4.jpg") # fails, unknown raw mode, ###BUG [try converting it. ###e]
...
testexpr_11q5cx2_g4 = imagetest_x2("/materialBuilder/DNA/paul notebook pages/stages1-4.jpg") # shows the "last resort" file.
...
testexpr_11q5cx2_g5 = imagetest_x2("/materialBuilder/DNA/pwkr-user-story/notebook page images/stages1-4.jpg") # works, but poor resolution
testexpr_11q5cx2_g5_bigbad = imagetest_x2("/materialBuilder/DNA/pwkr-user-story/notebook page images/stages1-4.jpg",
                                          ideal_width = 1275,
