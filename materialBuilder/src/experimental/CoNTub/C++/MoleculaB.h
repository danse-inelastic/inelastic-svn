...
{
    int nselec;
    String info;		//peque�a cadena informativa para pasar un mini titulo
 ...
 public:
    ...
    //metodo paraeliminar conectividades redundantes, angulos demasiado peque�os (<60, en principio)
    int depuraconec ();
