...
//Metodos para a�adir etiquetas personalizadas
...
int MoleculaB::depuraconec ()	//metodo paraeliminar conectividades redundantes, angulos demasiado peque�os (<60, en principio)
{
    int dc = 0;
    for (int i = 0; i < susatomos.size (); i++) {
