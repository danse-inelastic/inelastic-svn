...
def drawOneFrame(t, filename):
    ...
    materialBuilder_xpos = 50
    materialBuilder_ypos = move(t, 460, 140)
    cmd = (('composite -geometry +%d+%d ' % (materialBuilder_xpos, materialBuilder_ypos)) +
           'materialBuilder_logos/materialBuilder_logo_text_outline_medium.png black.jpg /tmp/foo.jpg')
    jobqueue.do(cmd)
...
####################################################################
# Start with the materialBuilder logo sequence
