...
$Id: preferences.py,v 1.20 2007/07/04 22:19:28 bsmith Exp $
...
def _make_prefs_shelf():
    ...
    materialBuilder = platform.find_or_make_materialBuilder_directory()
    global dbname
    _shelfname = os.path.join( materialBuilder, "Preferences", "%s-shelf" % dbname )
