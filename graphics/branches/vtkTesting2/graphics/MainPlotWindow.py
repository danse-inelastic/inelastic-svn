...
#from graphics.MatplotlibController import MatplotlibController
...
#from graphics.PropertyEditorController import PropertyEditorController
...
#        self.backend='vtk'
        ...
        #self.matplotlibController = MatplotlibController(self)
        #self.propertyEditorController = PropertyEditorController(self)
#        self.plotBrowserController = PlotBrowserController(self)
...
#        self._mgr.AddPane(self.matplotlibController.CreateMatplotlib(), wx.CENTER)
        ...
        self._mgr.AddPane(self.CreateMatplotlib(), wx.aui.AuiPaneInfo().
                           Name("Graphics").Caption("Graphics").Center().Layer(1).Position(1).CloseButton(True).MaximizeButton(True))
        #Left Pane
...
#                          LeftDockable(False).RightDockable(False))
        ...
        self.Bind(wx.EVT_MENU, self.OnLoadColumnFile, id=ID_ColumnFile)
...
#        self.loadLine(x,y)
    ...
    def CreateVtk(self): 
        self.backendWrap = None #VtkWrap(self,-1)    
        self.backend = 'vtk'
        return self.backendWrap
