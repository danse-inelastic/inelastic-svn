...
from graphics.PropertyEditorTable import PropertyEditorTable
...
class PropertyEditor(gridlib.Grid):
   ...
   # currentItem = PlotBrowser.currentItem
    ...
    def __init__(self, parent):
        gridlib.Grid.__init__(self, parent, -1, size=(252,546))
        self.parent=parent
        ...
        from graphics.MainPlotWindow import backend as MPWBackend
        self.backend = MPWBackend
        
        self.table = PropertyEditorTable(self)
