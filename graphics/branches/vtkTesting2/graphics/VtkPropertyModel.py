...
#fig=
figureProps = gcf()._prop.items()
figurePropDataTypes = {'axshape':edString, 'axes':edString, 'curax':edString, 'size': edString}
...
axesProps = gca()._prop.items()

axesPropDataTypes={'zmax':edString, 'xlim':edString, 'diffusecolor':edString, 'zmin':edString, 
...
linePropDataTypes={'function':edString,'linecolor':edString,'zlim':edString,'description':edString,'xlim':edString,
