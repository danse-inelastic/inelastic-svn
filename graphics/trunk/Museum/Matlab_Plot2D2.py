'''displays a multiple x-y plot with Matlab
...
Notes
    ...
    invokes sam.eval("plot(x,y,x2,y2,'k-','Linewidth',2)")
'''
...
class MatlabPlot2D2(Application):
    '''Pyre adaption of mmckerns Matlab_Plot2D2.py cobra component'''
    ...
    def run(self):
        ...
        sam.put("x2",input_list[2])
        sam.put("y2",input_list[3])

        #check if put worked
        sam.tools.whos()

        #create an 2d plot
        sam.eval("plot(x,y,x2,y2,'k-','Linewidth',2)")
    ...
    def __init__(self, name='MatlabPlot2D2', **kwds):
...
if __name__ == '__main__':
    ...
    l = [x, y1, x, y2] 
    mp2d2 = MatlabPlot2D2(input_list=l)
    print "~~~~~~~~~~~~~~~~~~"
    print "MatlabPlot2D2 Test"
    mp2d2.main()
