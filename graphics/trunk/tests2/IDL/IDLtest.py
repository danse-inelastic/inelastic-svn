...
#  IDLtest.py
#  
#  6/20/2005 version 0.0.2a (copied from pyIDLtest.py)
...
#       return
    ...
    def test_IDLmap(self):
        ...
        types = {3:'Int32', 1:'Int8', 2:'Int16', 'Int16':2, 4:'Float32',\
                 ...
                 12:'UInt16', 'Complex64':6, 'UInt16':12,\
                 'Int8':1, 'Float32':4, 'UInt64':15, 15:'UInt64', \
                 'Int64':14, 14:'Int64', 13:'UInt32', 'UInt32':13}
...
#                    "failure to print full help message")
        ...
        return #TODO: need to catch IDL's stdout, then uncomment tests
...
#       IO for structure TESTS NOT IMPLEMENTED
    ...
    def test_IDLwho(self):
        ...
        self.assertEqual(whos,self.session.who())
        self.assertEqual(whos,self.session.who(local=True))
        #stdout #TODO: need to catch IDL's stdout, then uncomment tests
...
'''
    ...
    def test_IDL_putexpr(self): #FIXME: add testing using matrix!
        ...
        self.assertEqual(whos,self.session.whos)
        self.assertEqual(whos,self.session.who())
        #failures name #FIXME: need Errors? standatdization?
        '''
...
# version
__id__ = "$Id: IDLtest.py 151 2006-05-25 14:01:53Z mike $"
