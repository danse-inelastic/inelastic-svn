...
figureProps = [#['alpha transparency', '1.0', edString, 'alpha'],
                ...
                ['figure dpi', '80', edString, 'dpi'],
                ['edge color', '', edColor, 'edgecolor'],
                ['face color', '', edColor, 'facecolor'],
                ['figure height', '', edString, 'figheight'],
                #  figsize_inches: unknown
                #  figure: a matplotlib.figure.Figure instance
                ['figure width', '', edString, 'figwidth'],
                #  frameon: boolean
                #  label: any string
                #  lod: [True | False]
...
axesProps = [['adjustable', 1.0, edAdjustable, 'adjustable'],
             ['alpha transparency', '1.0', edString, 'alpha'],
...
plottableProps = [['line width', 0.5, edFloat, 'linewidth'],     # line width in points
              ['line style', '-', edString, 'linestyle'],
              #['line color', 'b', edString, 'color']
              ['line color', 0, edInt, 'color']]

lineProps = [['alpha transparency', '1.0', edString, 'alpha'],
            ['animated', False, edBoolean, 'animated'],
            ...
            ['line width', '0.5', edString, 'linewidth'],  
            #  lod: [True | False]   
            ['line marker', 'None', edString, 'marker'],  
            ['marker edge color', 'auto', edString, 'markeredgecolor'],
            ['marker edge width', '0.5', edString, 'markeredgewidth'],
            ['marker face color', 'auto', edString, 'markerfacecolor'],
            ['marker size', '6', edString, 'markersize'], 
            ...
            #  transform: a matplotlib.transform transformation instance
            ['visible', True, edBoolean, 'visible'],
            #['x data', '', edString, 'xdata'], comment out because it can get big
            #['y data', '', edString, 'ydata'], comment out because it can get big
            ['z order', '2', edString, 'zorder']   
]
