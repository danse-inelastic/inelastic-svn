...
from graphics.numpytools import zeros, ones, exp, NewAxis, reshape, ravel, \
     Float, meshgrid, seq
...
from graphics.numpytools import arctan2, sqrt, shape, log, sin, cos
