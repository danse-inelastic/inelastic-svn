...
class Graph:
    ...
    def add(self,plottable):
        ...
        #TODO: this is not the most intuitive way to keep track of a rotating color
        # scheme.  perhaps a function that rotates everytime is is called would be better
...
class Plottable:
    ...
    def colors(self):
        """Return the number of colors needed to render the object"""
        return 1
...
def demo_plotter(graph):
    ...
    from mplwxplotter import Plotter
