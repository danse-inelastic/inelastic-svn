...
high-temperature reference lattice shown at the origin of Figs.~\ref{gpd1}
and~\ref{gpd2}, in which molecules remain translationally ordered but are
...
An analog to molecular crystal GPDs are Ising-type GPDs, such as the Axial Next Nearest Neighbor Ising model (ANNNI),
which has been used for decades to explore both commensurate and incommensurate
phases\cite{Gendiar05, Kasama06, Muraoka99, Sato99,
Kim95} that can be applied to complex
materials such as silicon carbide, titanium aluminum, group-IV element
