...
\aff[d]{SSCI, a division of Aptuit, West Lafayette,
Indiana 47906 \country{USA}}
...
A GPD example is shown in Figs.~\ref{gpd1} and~\ref{gpd2}, where molecules are disordered (shown as spheres) at the 
center of the diagrams.  As the temperature is lowered, the molecules adopt a fixed
orientation.  This induces a structural change from fcc, a high-temperature reference lattice, to one of the 10 new phases shown 
in the figures.   
...
(CSD)~\cite{Allen02}, Crystallography Open Database~\cite{Grazulis09}, or Virtual Neutron Facility~\cite{vnf09}. Also, by locating new
structures that may have more desirable properties than an existing crystal structure, GPDs provide feedback for molecular synthesis for crystal engineering. Further, GPDs
...
hcp, sc\} and use these as a test set to see how many parameters are required
in molecular crystal GPDs. Each of these reference lattices has at least four
crystal structures with monomer synthons in the data set.  This means a given structure can be categorized as a subgroup of one of these reference lattices when single
...
Now that we have a potential that is capable of producing all the experimental
structures from \cite{McClurg09} for the \{fcc, sc, hcp, bcc\} reference
lattices, and we have input each structure's molecular Euler angles to reduce
it to a form such as Eq.~(\ref{energyOfStructure}), we need to develop an algorithm that will isolate this structure in
$\mb{\nu}$-space as the most thermodynamically stable structure. To this end we
propose a general minimum energy difference algorithm that makes use of the
candidate lattice libraries derived in Sec.~\ref{collection}.

This algorithm proceeds as follows. First, normalize the
$\mb{\nu}$ vector by projecting it onto the unit hypersphere since only
relative $\mb{\nu}$ magnitudes affect the phase as $T\rightarrow 0$. Then, taking the library of structures discussed previously in this section, minimize the difference of the energy of the target structure $E_{target}$ and the minimal energy structure in the
collection $\{E_{lib}(\mb{\nu},\mb{\omega})\}$.  Thus
a vector $\nu_{RP}$ is sought that minimizes
\begin{equation}
\label{Endiff} \Delta E =
E_{target}(\mb{\nu})-\min\{E_{lib}(\mb{\nu},\mb{\omega})\}.
\end{equation}
We note that for a finite library, this gives the point in $\mb{\nu}$ space of
the \emph{largest} energy gap between $E_{\mathrm{target}}$ and any other
structures in the library and is representative of the family of intermolecular
potentials consistent with the target structure. For an
infinite library, $\Delta E$ is bounded below by zero since
...
strains in the model, lack of explicit second nearest-neighbor interactions,
the low-temperature limit discussed in Sec.~\ref{figureofmerit}, or missing
quantum effects. Another reason may be that the reported experimental phase is in fact metastable in the limit $T\rightarrow 0$. Ostwald's step rule supports this possibility.  The
...
\harvarditem{Allen \harvardand\ Motherwell}{2002}{Allen02}
Allen, F.~H. \harvardand\ Motherwell, W. D.~S.  \harvardyearleft
  2002\harvardyearright{}.
\newblock \emph{Acta Cryst. B}, \volbf{58}, 407--422.

\harvarditem{Aparicio-Martinez \harvardand\
  Hall}{2007\emph{a}}{AparicioMartinez07a}
Aparicio-Martinez, S. \harvardand\ Hall, K.~R.  \harvardyearleft
  2007\emph{a}\harvardyearright{}.
\newblock \emph{Ind. Eng. Chem. Res.} \volbf{46}, 273--284.

\harvarditem{Aparicio-Martinez \harvardand\
  Hall}{2007\emph{b}}{AparicioMartinez07b}
Aparicio-Martinez, S. \harvardand\ Hall, K.~R.  \harvardyearleft
  2007\emph{b}\harvardyearright{}.
\newblock \emph{Ind. Eng. Chem. Res.} \volbf{46}, 285--290.

\harvarditem[van~der Avoird \emph{et~al.}]{van~der Avoird, Wormer \harvardand\
  Moszynski}{1994}{Avoird94}
van~der Avoird, A., Wormer, P. E.~S. \harvardand\ Moszynski, R.
  \harvardyearleft 1994\harvardyearright{}.
\newblock \emph{Chem. Rev.} \volbf{94}, 1931--1974.

\harvarditem[van~der Avoird \emph{et~al.}]{van~der Avoird, Wormer, Mulder
  \harvardand\ Berns}{1980}{Avoird80}
van~der Avoird, A., Wormer, P. E.~S., Mulder, F. \harvardand\ Berns, R.~M.
  \harvardyearleft 1980\harvardyearright{}.
\newblock \emph{Topics in Current Chemistry}, \volbf{93}, 1--50.

\harvarditem[Bolz \emph{et~al.}]{Bolz, Deiters, Peters \harvardand\
  de~Loos}{1998}{Bolz98}
Bolz, A., Deiters, U.~K., Peters, C.~J. \harvardand\ de~Loos, T.~W.
  \harvardyearleft 1998\harvardyearright{}.
\newblock \emph{Pure Appl. Chem.} \volbf{70}, 2233.

\harvarditem{Bradley \harvardand\ Cracknell}{1972}{Bradley72}
Bradley, C.~J. \harvardand\ Cracknell, A.~P.  \harvardyearleft
  1972\harvardyearright{}.
\newblock \emph{The Mathematical Theory of Symmetry in Solids}.
\newblock New York: Oxford University Press.

\harvarditem[Braga \emph{et~al.}]{Braga, Grepioni \harvardand\
  Orpen}{1999}{Braga99}
Braga, D., Grepioni, F. \harvardand\ Orpen, A.~G. (eds.)  \harvardyearleft
  1999\harvardyearright{}.
\newblock \emph{Crystal Engineering: From Molecules and Crystals to Materials}.
\newblock Boston: Kluwer Academic.

\harvarditem{Briels}{1980}{Briels80}
Briels, W.~J.  \harvardyearleft 1980\harvardyearright{}.
\newblock \emph{J. Chem. Phys.} \volbf{73}, 1850--1861.

\harvarditem{Cismondi \harvardand\ Michelsen}{2007}{Cismondi07}
Cismondi, M. \harvardand\ Michelsen, M.~L.  \harvardyearleft
  2007\harvardyearright{}.
\newblock \emph{J. Supercrit. Fluid.} \volbf{39}, 287--295.

\harvarditem{Colinet \harvardand\ Pasturel}{2002}{Colinet02}
Colinet, C. \harvardand\ Pasturel, A.  \harvardyearleft
  2002\harvardyearright{}.
\newblock \emph{Intermetallics}, \volbf{10}, 751.

\harvarditem{Desiraju}{1989}{Desiraju89}
Desiraju, G.~R.  \harvardyearleft 1989\harvardyearright{}.
\newblock \emph{Crystal Engineering: The Design of Organic Solids}.
\newblock New York: Elsevier.

\harvarditem{Gavezzotti}{2007}{Gavezzotti07}
Gavezzotti, A.  \harvardyearleft 2007\harvardyearright{}.
\newblock \emph{Molecular Aggregation: Structure Analysis and Molecular
  Simulation of Crystals and Liquids}.
\newblock USA: Oxford University Press.

\harvarditem{Gdanitz}{1997}{Gdanitz97}
Gdanitz, R.~J.  \harvardyearleft 1997\harvardyearright{}.
\newblock In \emph{Theoretical Aspects and Computer Modeling of the Molecular
  Solid State}, edited by A.~Gavezzotti, pp. 185--201. New York: Wiley.

\harvarditem{Gendiar \harvardand\ Nishino}{2005}{Gendiar05}
Gendiar, A. \harvardand\ Nishino, T.  \harvardyearleft 2005\harvardyearright{}.
\newblock \emph{Phys. Rev. B}, \volbf{71}, 024404.

\harvarditem[Grazulis \emph{et~al.}]{Grazulis, Chateigner, Downs, Yokochi,
  Quiros, Lutterotti, Manakova, Butkus, Moeck \harvardand\
  Le~Bail}{2009}{Grazulis09}
Grazulis, S., Chateigner, D., Downs, R.~T., Yokochi, A. F.~T., Quiros, M.,
  Lutterotti, L., Manakova, E., Butkus, J., Moeck, P. \harvardand\ Le~Bail, A.
  \harvardyearleft 2009\harvardyearright{}.
\newblock \emph{J. Appl. Cryst.} \volbf{42}, 726--729.

\harvarditem[Harrison \emph{et~al.}]{Harrison, Marsh \harvardand\
  Trotter}{1972}{Harrison72}
Harrison, W., Marsh, W. \harvardand\ Trotter, J.  \harvardyearleft
  1972\harvardyearright{}.
\newblock \emph{J. Chem. Soc., Dalton Trans.} p. 1009.

\harvarditem[Hloucha \emph{et~al.}]{Hloucha, Lodge, Lenhoff \harvardand\
  Sandler}{2001}{Hloucha01}
Hloucha, M., Lodge, J., Lenhoff, A. \harvardand\ Sandler, S.  \harvardyearleft
  2001\harvardyearright{}.
\newblock \emph{Cryst.} \volbf{64}, 060104(R)--1--060104(R)--4.

\harvarditem{Holland}{1992}{Holland92}
Holland, J.~H.  \harvardyearleft 1992\harvardyearright{}.
\newblock \emph{Adaptation in Natural and Artificial Systems: An Introductory
  Analysis with Applications to Biology, Control, and Artificial Intelligence}.
\newblock Cambridge: The MIT Press.

\harvarditem[Holman \emph{et~al.}]{Holman, Pivovar, Swift \harvardand\
  Ward}{2001}{Holman01b}
Holman, K.~T., Pivovar, A.~M., Swift, J.~A. \harvardand\ Ward, M.~D.
  \harvardyearleft 2001\harvardyearright{}.
\newblock \emph{Acc. Chem. Res.} \volbf{34}, 107--118.

\harvarditem{James \harvardand\ Keenan}{1959}{James59}
James, H.~M. \harvardand\ Keenan, T.~A.  \harvardyearleft
  1959\harvardyearright{}.
\newblock \emph{J. Chem. Phys.} \volbf{31}, 12--41.

\harvarditem[Kasama \emph{et~al.}]{Kasama, Muraoka \harvardand\
  Idogaki1}{2006}{Kasama06}
Kasama, T., Muraoka, Y. \harvardand\ Idogaki1, T.  \harvardyearleft
  2006\harvardyearright{}.
\newblock \emph{Phys. Rev. B}, \volbf{73}, 214411.

\harvarditem[Keith \emph{et~al.}]{Keith, McClurg \harvardand\
  Fultz}{2009}{Keith09b}
Keith, J.~B., McClurg, R.~B. \harvardand\ Fultz, B.  \harvardyearleft
  2009\harvardyearright{}.
\newblock In preparation.

\harvarditem[Keith \emph{et~al.}]{Keith, Mettes \harvardand\
  McClurg}{2004}{Keith04c}
Keith, J.~B., Mettes, J.~A. \harvardand\ McClurg, R.~B.  \harvardyearleft
  2004\harvardyearright{}.
\newblock \emph{Crystal Growth and Design}, \volbf{4}, 1009--1012.

\harvarditem[Kim \emph{et~al.}]{Kim, Mori \harvardand\ Harada}{1995}{Kim95}
Kim, J.-J., Mori, S. \harvardand\ Harada, I.  \harvardyearleft
  1995\harvardyearright{}.
\newblock \emph{Phys. Lett. A}, \volbf{202}, 68.

\harvarditem[Kirkpatrick \emph{et~al.}]{Kirkpatrick, Gelatt~Jr \harvardand\
  Vecchi}{1983}{Kirkpatrick83}
Kirkpatrick, S., Gelatt~Jr, C. \harvardand\ Vecchi, M.  \harvardyearleft
  1983\harvardyearright{}.
\newblock \emph{Science}, \volbf{220}, 671 -- 680.

\harvarditem{van Konyenburg \harvardand\ Scott}{1980}{vanKonyenburg80}
van Konyenburg, P.~H. \harvardand\ Scott, R.~L.  \harvardyearleft
  1980\harvardyearright{}.
\newblock \emph{Philos. Trans. R. Soc. London, Ser. A}, \volbf{298}, 495--540.

\harvarditem[Kovalev \emph{et~al.}]{Kovalev, Worthey, Stokes \harvardand\
  Hatch}{1993}{Kovalev93}
Kovalev, O.~V., Worthey, G.~C., Stokes, H.~T. \harvardand\ Hatch, D.~M.
  \harvardyearleft 1993\harvardyearright{}.
\newblock \emph{Representation of Crystallographic Space Groups: Irreducible
  Representations, Induced Representation and Corepresentations}.
\newblock Berkshire, Great Britian: Gordon and Breach Science Publishers.

\harvarditem{Lamoen \harvardand\ Michel}{1999}{Lamoen99}
Lamoen, D. \harvardand\ Michel, K.~H.  \harvardyearleft
  1999\harvardyearright{}.
\newblock \emph{Phase Transitions}, \volbf{67}, 789--807.

\harvarditem{Lang}{2003}{ggobi03}
Lang, D.~T.,  \harvardyearleft 2003\harvardyearright{}.
\newblock Ggobi.
\newblock www.ggobi.org.

\harvarditem{Lin \harvardand\ Keith}{2009}{vnf09}
Lin, J. Y.~Y. \harvardand\ Keith, J.~B.,  \harvardyearleft
  2009\harvardyearright{}.
\newblock Virtual neutron facility.
\newblock vnf.caltech.edu.

\harvarditem[Lommerse \emph{et~al.}]{Lommerse, Motherwell, Ammon, Dunitz,
  Gavezzotti, Hofmann, Leusen, Mooij, Price, Schweizer, Schmidt, van Eijck,
  Verwer \harvardand\ Williams}{2000}{Lommerse00}
Lommerse, J. P.~M., Motherwell, W. D.~S., Ammon, H.~L., Dunitz, J.~D.,
  Gavezzotti, A., Hofmann, D. W.~M., Leusen, F. J.~J., Mooij, W. T.~M., Price,
  S.~L., Schweizer, B., Schmidt, M.~U., van Eijck, B.~P., Verwer, P.
  \harvardand\ Williams, D.~E.  \harvardyearleft 2000\harvardyearright{}.
\newblock \emph{Acta Crystallogr. B}, \volbf{56}, 697--714.

\harvarditem{Lynden-Bell \harvardand\ Michel}{1994}{LyndenBell94}
Lynden-Bell, R.~M. \harvardand\ Michel, K.~H.  \harvardyearleft
  1994\harvardyearright{}.
\newblock \emph{Rev. Mod. Phys.} \volbf{66}, 721--762.

\harvarditem{McClurg \harvardand\ Keith}{2009}{McClurg09}
McClurg, R.~B. \harvardand\ Keith, J.~B.  \harvardyearleft
  2009\harvardyearright{}.
\newblock Molecular crystal global phase diagrams $\mathrm{II}$: Reference
  lattices.
\newblock Submitted.

\harvarditem[Mettes \emph{et~al.}]{Mettes, Keith \harvardand\
  McClurg}{2004}{Mettes04}
Mettes, J.~A., Keith, J.~B. \harvardand\ McClurg, R.~B.  \harvardyearleft
  2004\harvardyearright{}.
\newblock \emph{Acta Cryst. A}, \volbf{60}, 621--636.

\harvarditem[Michel \emph{et~al.}]{Michel, Copley \harvardand\
  Neumann}{1992}{Michel92}
Michel, K.~H., Copley, J. R.~D. \harvardand\ Neumann, D.~A.  \harvardyearleft
  1992\harvardyearright{}.
\newblock \emph{Phys. Rev. Lett.} \volbf{68}, 2929--2932.

\harvarditem[Missaghi \emph{et~al.}]{Missaghi, Mettes \harvardand\
  McClurg}{2009}{Missaghi09}
Missaghi, M.~N., Mettes, J.~A. \harvardand\ McClurg, R.~B.  \harvardyearleft
  2009\harvardyearright{}.
\newblock In Preparation.

\harvarditem[More \emph{et~al.}]{More, Baert \harvardand\
  Lefebvre}{1977}{More77}
More, M., Baert, F. \harvardand\ Lefebvre, J.  \harvardyearleft
  1977\harvardyearright{}.
\newblock \emph{Acta Cryst. B}, \volbf{33}, 3681--3684.

\harvarditem{Moulton \harvardand\ Zaworotko}{2001}{Moulton01}
Moulton, B. \harvardand\ Zaworotko, M.~J.  \harvardyearleft
  2001\harvardyearright{}.
\newblock \emph{Chem. Rev.} \volbf{101}, 1629--1658.

\harvarditem[Neumann \emph{et~al.}]{Neumann, Press, Noldeke, Asmussen, Prager
  \harvardand\ Ibberson}{2003}{Neumann03}
Neumann, M.~A., Press, W., Noldeke, C., Asmussen, B., Prager, M. \harvardand\
  Ibberson, R.~M.  \harvardyearleft 2003\harvardyearright{}.
\newblock \emph{J. Chem. Phys.} \volbf{119}, 1586--1589.

\harvarditem[Padmaja \emph{et~al.}]{Padmaja, Ramakumar \harvardand\
  Viswamitra}{1990}{Padmaja90}
Padmaja, N., Ramakumar, S. \harvardand\ Viswamitra, M.~A.  \harvardyearleft
  1990\harvardyearright{}.
\newblock \emph{Acta Cryst. A}, \volbf{46}, 725--730.

\harvarditem[van Pelt \emph{et~al.}]{van Pelt, Peters, Swaan-Arons \harvardand\
  Dieters}{1995}{vanPelt95}
van Pelt, A., Peters, C.~J., Swaan-Arons, J. \harvardand\ Dieters, U.~K.
  \harvardyearleft 1995\harvardyearright{}.
\newblock \emph{J. Chem. Phys.} \volbf{102}, 3361.

\harvarditem[Polishuk \emph{et~al.}]{Polishuk, Wisniak \harvardand\
  Segura}{2002}{Polishuk02}
Polishuk, I., Wisniak, J. \harvardand\ Segura, H.  \harvardyearleft
  2002\harvardyearright{}.
\newblock \emph{Phys. Chem. Chem. Phys.} \volbf{4}, 879.

\harvarditem[Polishuk \emph{et~al.}]{Polishuk, Wisniak, Segura, Yelash
  \harvardand\ Kraska}{2000}{Polishuk00}
Polishuk, I., Wisniak, J., Segura, H., Yelash, L.~V. \harvardand\ Kraska, T.
  \harvardyearleft 2000\harvardyearright{}.
\newblock \emph{Fluid Phase Equilib.} \volbf{172}, 1--26.

\harvarditem[Raffy \emph{et~al.}]{Raffy, Furthmuller \harvardand\
  Bechstedt}{2002}{Raffy02}
Raffy, C., Furthmuller, J. \harvardand\ Bechstedt, F.  \harvardyearleft
  2002\harvardyearright{}.
\newblock \emph{Phys. Rev. B}, \volbf{66}, 075201.

\harvarditem{Sato \harvardand\ Matsubara}{1999}{Sato99}
Sato, A. \harvardand\ Matsubara, F.  \harvardyearleft 1999\harvardyearright{}.
\newblock \emph{Phys. Rev. B}, \volbf{60}, 10316.

\harvarditem{Schmalzried}{2003}{Schmalzried03}
Schmalzried, H.  \harvardyearleft 2003\harvardyearright{}.
\newblock \emph{Zeit. fur Physik. Chem.} \volbf{217}, 1281--1302.

\harvarditem{Sherwood}{1979}{Sherwood79}
Sherwood, J.~N.  \harvardyearleft 1979\harvardyearright{}.
\newblock \emph{The Plastically Crystalline State}.
\newblock New York: Wiley.

\harvarditem{Simon}{2000}{Bassoul00}
Simon, J.~Bassoul, P.  \harvardyearleft 2000\harvardyearright{}.
\newblock \emph{Design of Molecular Materials: Supramolecular Engineering}.
\newblock New York: John Wiley and Sons.

\harvarditem{Stokes \harvardand\ Hatch}{1988}{Stokes88}
Stokes, H.~T. \harvardand\ Hatch, D.~M.  \harvardyearleft
  1988\harvardyearright{}.
\newblock \emph{Isotropy Subgroups of the 230 Crystallographic Space Groups}.
\newblock Teaneck, NJ: World Scientific.

\harvarditem{Stokes \harvardand\ Hatch}{2002}{Stokes02a}
Stokes, H.~T. \harvardand\ Hatch, D.~M.  \harvardyearleft
  2002\harvardyearright{}.
\newblock \emph{Phys. Rev. B}, \volbf{65}, 144114--1--144114--12.

\harvarditem[Stokes \emph{et~al.}]{Stokes, Hatch \harvardand\
  Campbell}{2007}{Stokes07}
Stokes, H.~T., Hatch, D.~M. \harvardand\ Campbell, B.~J.,  \harvardyearleft
  2007\harvardyearright{}.
\newblock Isotropy.
\newblock stokes.byu.edu/isotropy.html.

\harvarditem[Stokes \emph{et~al.}]{Stokes, Hatch \harvardand\
  Wells}{1991}{Stokes91}
Stokes, H.~T., Hatch, D.~M. \harvardand\ Wells, J.~D.  \harvardyearleft
  1991\harvardyearright{}.
\newblock \emph{Phys. Rev. B.} \volbf{43}, 11010--11018.

\harvarditem{Stone \harvardand\ Tough}{1984}{Stone84}
Stone, A.~J. \harvardand\ Tough, R. J.~A.  \harvardyearleft
  1984\harvardyearright{}.
\newblock \emph{Chem. Phys. Lett.} \volbf{110}, 123--129.

\harvarditem[Thalladi \emph{et~al.}]{Thalladi, Goud, Hoy, Allen, Howard
  \harvardand\ Desiraju}{1996}{Thalladi96}
Thalladi, V.~R., Goud, B.~S., Hoy, V.~J., Allen, F.~H., Howard, J. A.~K.
  \harvardand\ Desiraju, G.~R.  \harvardyearleft 1996\harvardyearright{}.
\newblock \emph{Chem. Commun.} pp. 401--402.

\harvarditem[Varshalovich \emph{et~al.}]{Varshalovich, Moskalev \harvardand\
  Khersonskii}{1988}{Varshalovich88}
Varshalovich, D.~A., Moskalev, A.~N. \harvardand\ Khersonskii, V.~K.
  \harvardyearleft 1988\harvardyearright{}.
\newblock \emph{Quantum Theory of Angular Momentum}.
\newblock Teaneck, NJ: World Scientific.

\harvarditem{Verwer \harvardand\ Leusen}{1998}{Verwer98}
Verwer, P. \harvardand\ Leusen, F. J.~J.  \harvardyearleft
  1998\harvardyearright{}.
\newblock In \emph{Reviews in Computational Chemistry}, edited by K.~B.
  Lipkowitz \harvardand\ D.~B. Boyd, vol.~12, pp. 327--366. New York:
  Wiley-VCH.

\harvarditem[Wong-Leung \emph{et~al.}]{Wong-Leung, Linnarsson, B.~G.~Svensson
  \harvardand\ Cockayne}{2005}{Wong-Leung05}
Wong-Leung, J., Linnarsson, M.~K., B.~G.~Svensson, B.~G. \harvardand\ Cockayne,
  D. J.~H.  \harvardyearleft 2005\harvardyearright{}.
\newblock \emph{Phys. Rev. B}, \volbf{71}, 165210.

\harvarditem[Y.~Muraoka \emph{et~al.}]{Y.~Muraoka, Oda \harvardand\
  Idogaki}{1999}{Muraoka99}
Y.~Muraoka, Y., Oda, K. \harvardand\ Idogaki, T.  \harvardyearleft
  1999\harvardyearright{}.
\newblock \emph{J. Magn. Magn. Mater.} \volbf{195}, 156.

\harvarditem[Zak \emph{et~al.}]{Zak, Casher, Gluck \harvardand\
  Gur}{1969}{Zak69}
Zak, J., Casher, H., Gluck, H. \harvardand\ Gur, Y.  \harvardyearleft
  1969\harvardyearright{}.
\newblock \emph{The Irreducible Representations of Space Groups}.
\newblock New York: Benjamin.
