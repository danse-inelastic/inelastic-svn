...
//	private JButton	btnFireball = new JButton("Export to Fireball");
	...
	private JButton linkTest = new JButton("Link");
...
//		add(btnFireball, btnConstraints);
		...
		btnJmol.addActionListener(new ActionListener() {
...
//		});
		...
		// Changed 1000 to 100 for AjaxSwing
		txtQuery.setText("SELECT * FROM data ORDER BY entry LIMIT 100");
...
*/
	...
	private JButton getBtnSearch() {
		if (btnSearch == null) {
			...
			btnSearch.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					//updateQuery() added for AjaxSwing
					updateQuery();
	...
	//Below commented out to make it work for AjaxSwing
...
//					}
	...
	// To replace keyAdapter. updateQuery made into separate method and 
	//is called when search button is pressed, for AjaxSwing
