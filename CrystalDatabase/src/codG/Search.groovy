...
class Search extends JPanel 
        ...
        btnJmol.addMouseListener(new MouseAdapter(
                {void mouseClicked(MouseEvent e) {
                    try {
                        ...
                        spec = cp.species else 

                        spec = cp.newSpecies
                        if (cp.newCoordinates.size() == 0) 
                        coor = cp.coordinates else 
    ...
    private int getTable() {
        String tempString query = txtQuery.getText()
        int length = 1int number = 1000
        while (
    ...
    KeyAdapter generateQuery = new KeyAdapter(
        ...
        keyReleased(KeyEvent e) {
            ...
            if (!txtText.getText().equals("""")) {
                ...
                for <FOR_EACH_CLAUSE>String word</FOR_EACH_CLAUSE>{
            ...
            if (!txtElements.getText().equals("""")) {
                ...
                for <FOR_EACH_CLAUSE>String element</FOR_EACH_CLAUSE>{
    ...
    private String between(JTextField box1, JTextField box2, String field) {
        String line = """"String one = box1.getText()String two = box2.getText()
        if (!one.equals("""")) {
