...
class WebApplication(Base):
    ...
    class Inventory(Base.Inventory):
        ...
        # properties
        db = pyre.inventory.str(name='db', default='ent')
        ...
        clerk = pyre.inventory.facility(name="clerk", factory=ent.components.clerk)
        clerk.meta['tip'] = "the component that retrieves data from the various database tables"

        scribe = pyre.inventory.facility(name="scribe", factory=ent.components.scribe)
