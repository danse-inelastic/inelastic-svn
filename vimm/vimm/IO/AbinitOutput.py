#!/usr/bin/env python
"""\
 Abinitoutput.py - Reader for inputting abinit output files.
"""
...
from vimm.IO import AbinitInput

extensions=["out"]
filetype="Abinit output format"

def load(fullfilename,**kwargs):
    return AbinitInput.load(fullfilename,ofile=True)
