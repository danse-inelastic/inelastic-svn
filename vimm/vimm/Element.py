...
"""\
 ...
 Author: Richard P. Muller & David Dorsey
...
name = [
    ...
    'rubidium','strontium',
    'yttrium', 'zirconium','niobium','molybdenum','tecnitium',
        'rubidium','rhodium','palladium','silver','cadmium',
    ...
    'actinium','thorium','protactinium','uranium','neptunium','plutonium',
        ...
        'fermium','mendelvium','nobelium','lawrencium','rutherfordium',
...
#        print "Element: %s:%s already present in sym2no" % (key,value)
#    else:
#        sym2no[key] = value
...
rcov = [None, 0.32, 0.93, 1.23, 0.90, 0.82, 0.77, 0.75, 0.73, 0.72, 0.71,
        ...
        2.35, 1.98, 1.69, None, None, None, None, None, None, None, None,
        None, None, None, None, None, 1.60, 1.44, 1.34, 1.30, 1.28, 1.26,
