...
class FrameSep(wx.Frame):
    ...
    def __init__(self, parent, id, title, lib=None, **kwds):
        ...
        self.mbPanel = MatterBuilderPanel(self, lib)
...
#            pass
    ...
    def closemyself(self, *args):
        if self.mbPanel.lib != None:
            self.mbPanel.lib.camera = self.canvas.camera
            self.mbPanel.lib.material = self.material
            self.mbPanel.lib.render_options = self.renderOptions
        self.Destroy()
    
    def create_xyz_file(self):
        self.mbPanel.create_xyz_file()


class MatterBuilderPanel(wx.Panel):
    ...
    def make_toolbar(self):
        ...
        self.toolbar = wx.ToolBar(self, style=TBFLAGS)
        
        fileBtn = wx.Button(self, -1, "&File", (20,150), style=wx.NO_BORDER)
        self.Bind(wx.EVT_BUTTON, self.onFileWindow, fileBtn)
        self.toolbar.AddControl(fileBtn)
        #editBtn = wx.Button(self, -1, "&Edit", (20,150), style=wx.NO_BORDER)
        #self.Bind(wx.EVT_BUTTON, self.onEditWindow, editBtn)
        #self.toolbar.AddControl(editBtn)
        #self.makeFilemenu()
        #fileBtn.PopupMenu(self.filemenu)
...
#        sz = st.GetBestSize()
    ...
    def make_editmenu(self):
        ...
        #                     wx.ITEM_NORMAL)
        #self.toolbar.AddControl(self.editmenu)
    ...
    def make_viewmenu(self):
        ...
        self.viewmenu.Append(self.ID_HIDE_H,
                             ...
                             wx.ITEM_CHECK)
        #self.toolbar.AddControl(self.viewmenu)
    ...
    def make_toolmenu(self):
        ...
        #self.toolbar.AddTool(self.toolmenu)
...
#                             wx.ITEM_NORMAL)
        #self.toolbar.AddTool(self.helpmenu)
    ...
    def do_layout(self):
        ...
        sizer_1.Add(self.toolbar, 0, wx.EXPAND)
...
#        d.Destroy()
    ...
    def set_properties(self, height=400, width=400):
        #self.SetTitle(title)
