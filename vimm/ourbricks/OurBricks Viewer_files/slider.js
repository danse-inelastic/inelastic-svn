...
function slider (a_init, a_tpl, cb, element) {
    ...
    if (element) {
        document.getElementById(element).innerHTML = '<div style="width:' + this.n_controlWidth + 'px;height:' + this.n_controlHeight + 'px;border:0; background-image:url(' + this.s_imgControl + ')" id="sl' + this.n_id + 'base">' +
        '<img src="' +
        this.s_imgSlider +
        '" width="' +
        this.n_sliderWidth +
