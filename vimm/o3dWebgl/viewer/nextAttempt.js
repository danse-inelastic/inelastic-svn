...
function initStep2(clientElements) {
  ...
  //var g_sphereTransform = g_mainPack.createObject('Transform');//
  //g_sphereTransform.addShape(cube);

  // Parent the cube's transform to the client root.
  //g_sphereTransform.parent = g_client.root;

  //g_sphereTransform.cull=true;
