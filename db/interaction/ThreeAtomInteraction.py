...
class ThreeAtomInteraction(Component):
    '''This is a helper class that looks for atomic properties corresponding
to three atoms such as forcefield or Born von Karman interaction parameters'''
    ...
    def __init__(self, atom1, atom2, atom3):
        ...
        Component.__init__(self, 'ThreeAtomInteraction', facility=None)
        self.info=None
        self.atom1=atom1
        self.atom2=atom2
        self.atom3=atom3
        ...
        'threeAtom'+sep+atom1+'-'+atom2+'-'+atom3
        try:
...
if __name__ == "__main__":
    ta=ThreeAtomInteraction('H','N','C')
    ta.assignInteraction('threeBodyGulpEx10')
