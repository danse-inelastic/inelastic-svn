...
branding =  Branding(
    ...
    about_additions = ['Author: Brandon Keith, Prabhu Ramachandran'],
    # The about box image.
    about_image = 'DANSE_LOGO4.jpg',
    # The application icon.
    application_icon = 'm2.ico',
    # The application name.
    application_name = 'DANSE Graphics 3D'
)
...
views = [View(name="DANSE Graphics 3D",
...
PluginDefinition(
    ...
    # General info.
    name = "The DANSE Graphics 3D UI Plugin",
    version = "2.0",
