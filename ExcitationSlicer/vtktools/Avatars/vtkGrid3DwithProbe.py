...
from ASE.Visualization.VTK.IsoSurfaceSource import IsoSurfaceProbeSource
from ASE.Visualization.VTK.vtkDataFromObject import vtkStructuredGridsFromGrid3DProbeArray
from ASE.Visualization.VTK.Avatars.vtkGrid3D import _vtkGrid3DChild_,_vtkGrid3DParent_
...
class vtkSTM(vtkAvatar,_vtkGrid3DParent_):
	...
	def UpdateVTKData(self):
		...
		stmtool=self.GetSTMTool().Repeat(list(self.GetPeriods()))
                stmtool.grid = stmtool.grid.TranslateCoordinates(list(self.GetTranslation()),'passive')
