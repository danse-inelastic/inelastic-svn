...
VERSION=0.8pre1
DATE="2004-01-31"
#NB: this needs to be fixed to say -rDB2L... rather than -rDBL...
TAG=-rDBLATEX_0_8PRE1
...
echo or casellas@infres.enst.fr
...
cvs -z3 -d:pserver:anonymous@cvs.db2latex.sourceforge.net:/cvsroot/db2latex co $TAG db2latex 
